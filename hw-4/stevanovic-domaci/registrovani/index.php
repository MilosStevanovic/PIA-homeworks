			...
			<div class="header-bar-warp d-flex">
				...
				<nav class="top-nav-area w-100">
					...
					<ul class="main-menu primary-menu">
                        ...
                        <div id="prijava" class="popup-overlay">
        <div class="log-popup">
            <h2>Prijava</h2>
            <a class="close-window" href="#">&times;</a>
            <div class="log-content">
                <form action="../logovanje/login.php" method="post">
                    ...
                    <br>
                    <input type="submit" value="Prijava" name="signup-btn" class="btn-log">
                </form>
            </div>
        </div>
    </div>
                       ...
                       <div id="registracija" class="popup-overlay">
        <div class="log-popup">
            <h2>Registracija</h2>
            <a class="close-window" href="#">&times;</a>
            <div class="log-content">
                <form action="../logovanje/registracija.php" method="post">
                    <i class="fa fa-user icon"></i>
                    ...
                    <input type="submit" value="Potvrdi registraciju" name="signup-btn" class="btn-log">
                </form>
            </div>
        </div>
    </div>
