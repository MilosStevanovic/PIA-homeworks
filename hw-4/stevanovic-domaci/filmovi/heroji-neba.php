	...
	<section class="games-single-page">
		<div class="container">
			<div class="game-single-preview">
				<img src="../img/filmovi-2/heroji-neba.jpg" alt="flyboys">
			</div>
			<div class="row">
				<div class="col-xl-9 col-lg-8 col-md-7 game-single-content">
					
					<h2 class="gs-title">Heroji neba</h2>
					<h4>O filmu</h4>
					<p>Film oskarovca Tonija Bila bavi se američkim pilotima koji su se borili kao dobrovoljci u francuskoj eskadrili Lafajet. Likovi nisu temeljeni na stvarnim osobama, ali veoma uspešno dočaravaju entuzijazam i iskušenja stvarnih dobrovoljaca.

Izvanredna rekonstrukcija tog perioda, dobro režirane scene borbi aviona, i afirmacija 'staromodnih', a zapravo večnih vrednosti, prijateljstva, junaštva i ljubavi - veliki su aduti ovog prvorazrednog ostvarenja.<br><br>
                        
                    Žanr: akcija, drama, istorija. <br><br>
                        
                    Glumci: Džejms Franko, Žan Reno, Dženifer Deker.
						...
						<div class="widget-item">
							<div class="rating-widget">
								...
								<ul>
									...
									<li>Scenario<span>Fil Sirs</span></li>
									<li>Režiser<span>Toni Bil</span></li>
									<li>Trajanje<span>140 min.</span></li>
								</ul>
								<div class="rating">
