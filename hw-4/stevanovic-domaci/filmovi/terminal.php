	...
	<section class="games-single-page">
		<div class="container">
			<div class="game-single-preview">
				<img src="../img/filmovi-2/terminal.jpg" alt="Terminal">
			</div>
			<div class="row">
				<div class="col-xl-9 col-lg-8 col-md-7 game-single-content">
					
					<h2 class="gs-title">Terminal</h2>
					<h4>O filmu</h4>
					<p>
Viktor Navorski (Tom Hanks), stanovnik istočne Evrope, dolazi u New York u najnezgodnijem trenutku. Naime, nekoliko trenutaka pre nego je njegov avion trebao da poleti u njegovoj je državi izbio je rat koji je razbio njeno jedinstvo pa američke vlasti ne mogu prihvatiti Viktorov pasoš kao valjan. On se iznenada nađe u nestvarnoj situaciji: nije mu dozvoljen ulazak u Ameriku, a nemoguće ga je deportirtovati.<br><br>

Navorski mora da ostane na aerodromu dok se njegov status ne sredi, međutim, do toga neće doći tako brzo pa on u jednoj od aerodromskih čekaonica uređuje svoj novi dom. <br><br>
                        
                    Žanr: komedija, romansa, drama. <br><br>
                        
                    Glumci: Tom Henks, Ketrin Zeta-Džouns, Či MekBrajd.
					...
					<div id="stickySidebar">
						<div class="widget-item">
							<div class="rating-widget">
								...
								<ul>
									<li>Godina izlaska<span>2004.</span></li>
									
									<li>Scenario<span>Endrju Nikol</span></li>
									<li>Režiser<span>Stiven Spilberg</span></li>
									<li>Trajanje<span>128 min.</span></li>
								</ul>
								<div class="rating">
