					...
					<div id="stickySidebar">
						<div class="widget-item">
							<div class="rating-widget">
								...
								<ul>
									<li>Godina izlaska<span>2016.</span></li>
									
									<li>Scenario<span>Oriol Paolo</span></li>
									<li>Režiser<span>Oriol Paolo</span></li>
									<li>Trajanje<span>106 min.</span></li>
								</ul>
								<div class="rating">
