					...
					<div id="stickySidebar">
						<div class="widget-item">
							<div class="rating-widget">
								...
								<ul>
									<li>Godina izlaska<span>2018.</span></li>
									
									<li>Scenario<span>Nik Valelonga</span></li>
									<li>Režiser<span>Piter Fareli</span></li>
									<li>Trajanje<span>130 min.</span></li>
								</ul>
								<div class="rating">
