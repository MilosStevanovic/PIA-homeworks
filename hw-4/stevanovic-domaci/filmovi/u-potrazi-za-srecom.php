	...
	<section class="games-single-page">
		<div class="container">
			<div class="game-single-preview">
				<img src="../img/filmovi-2/u-potrazi-za-srecom.jpg" alt="u-potrazi-za-srecom">
			</div>
			<div class="row">
				<div class="col-xl-9 col-lg-8 col-md-7 game-single-content">
					
					<h2 class="gs-title">U potrazi za srećom</h2>
					<h4>O filmu</h4>
                    ...
                    Glumci: Vil Smit, Džejden Smit, Tendi Njutn.
						...
						<div class="widget-item">
							<div class="rating-widget">
								...
								<ul>
									...
									<li>Scenario<span>Stiv Konrad</span></li>
									<li>Režiser<span>Gabriele Mućino</span></li>
