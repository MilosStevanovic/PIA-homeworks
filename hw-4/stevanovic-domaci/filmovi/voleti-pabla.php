	...
	<section class="games-single-page">
		<div class="container">
			<div class="game-single-preview">
				<img src="../img/filmovi-2/loving-pablo.jpg" alt="loving-pablo">
			</div>
			<div class="row">
				<div class="col-xl-9 col-lg-8 col-md-7 game-single-content">
					
					<h2 class="gs-title">Voleti Pabla</h2>
					<h4>O filmu</h4>
					<p>Film govori o emotivnoj vezi između novinarke reporterke i jednog od najvećih narko bosova svih vremena, Pabla Eskobara. <br><br>
                        
                    Žanr: biografija, krimi, drama. <br><br>
                        
                    Glumci: Havier Bardem, Penelope Kruz, Piter Sarsgard.
					...
					<div id="stickySidebar">
						<div class="widget-item">
							<div class="rating-widget">
								...
								<ul>
									<li>Godina izlaska<span>2017.</span></li>
									
									<li>Scenario<span>F. de Aranoa</span></li>
									<li>Režiser<span>F. de Aranoa</span></li>
									<li>Trajanje<span>123 min.</span></li>
								</ul>
								<div class="rating">
