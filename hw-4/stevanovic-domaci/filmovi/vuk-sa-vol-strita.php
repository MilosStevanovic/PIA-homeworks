	...
	<section class="games-single-page">
		<div class="container">
			<div class="game-single-preview">
				<img src="../img/filmovi-2/wolf-of-wall-street.jpg" alt="wolf-of-wall-street">
			</div>
			<div class="row">
				<div class="col-xl-9 col-lg-8 col-md-7 game-single-content">
					
					<h2 class="gs-title">Vuk sa Vol Strita</h2>
					<h4>O filmu</h4>
					<p>Vuk sa Vol strita (engl. The Wolf of Wall Street) američka je crna komedija u režiji Martina Skorsezea iz 2013. godine, snimljena po istoimenoj knjizi memoara Džordana Belforta, dok je scenario napisao Terens Vinter. Priča iz Belfortove perspektive prati karijeru ovog berzanskog posrednika u Njujorku i to kako je njegova firma Stratton Oakmont bila umešane u korupciju i mnoge ilegalne akcije na Vol stritu, što je na kraju dovelo do njegovog propasti.<br><br>Film je premijerno prikazan u Njujorku 17. decembra 2013, a u američkim bioskopima je realizovan 25. decembra iste godine. Ostvario je veliku zaradu na bioskopskim blagajnama i naišao na pozitivne kritike, ali takođe je izazvao dosta polemika zbog moralne dvosmislenosti, seksualnog sadržaja, prisustva narkotika i vulgarnosti. Bio je je nominovan za brojne nagrade, uključujući i pet Oskara (najbolji film, najbolji režiser, najbolji adaptirani scenario, najbolji glumac i najbolji sporedni glumac).
                    <br><br>
                        
                    Žanr: komedija, krimi, biografija. <br><br>
                        
                    Glumci: Leonardo DiKaprio, Margot Robi, Džona Hil, Metju Makonahej, Kajl Čendler.
					...
					<div id="stickySidebar">
						<div class="widget-item">
							<div class="rating-widget">
								...
								<ul>
									<li>Godina izlaska<span>2013.</span></li>
									
									<li>Scenario<span>Terens Vinter</span></li>
									<li>Režiser<span>Martin Skorseze</span></li>
									<li>Trajanje<span>180 min.</span></li>
								</ul>
								<div class="rating">
