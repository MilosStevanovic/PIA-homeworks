	...
	<section class="games-single-page">
		<div class="container">
			<div class="game-single-preview">
				<img src="../img/filmovi-2/blood-diamond.jpg" alt="Krvavi dijamant">
			</div>
			<div class="row">
				<div class="col-xl-9 col-lg-8 col-md-7 game-single-content">
					
					<h2 class="gs-title">Krvavi dijamant</h2>
					<h4>O filmu</h4>
					<p>Krvavi dijamant (engl. Blood Diamond) je američki film iz 2006. u režiji Edvarda Zvika. Glavne uloge tumače Leonardo Dikaprio, Dženifer Koneli i Džimon Hansu.

Film je nominovan za pet Oskara i naišao je na pozitivan prijem kod kritičara, koji su posebno pohvalili glumu Dikaprija i Hansua.
                    <br><br>
                        
                        Tokom vrhunca građanskog rata u Sijera Leoneu,  sudbine dva potpuno različita čoveka će postati neraskidivo  spojene. Jedan je Solomon , Mende ribar,  čijeg  je sina oteo   Revolucionarni  ujedinjeni  front (RUF) i vrbovao ga  u decu vojnike.   Drugi je Arčer, bivši vojnik-plaćenik iz Zimbabvea,  sada krijumčar dijamanata. Obojica traže isto – veliki ružičasti dijamant koji će spasiti Život Solomonovog sina ali i omogućiti Arčeru da zauvek ode iz Afrike. Kako budu sve bliži cilju,  njihova nužna  povezanost  iz interesa će biti sve jača  ali i međusobno poverenje.<br><br>
                        
                    Žanr: avantura, drama, triler. <br><br>
                        
                    Glumci: Leonardo DiKaprio, Đimon Hunsu, Dženifer Koneli.
						...
						<div class="widget-item">
							<div class="rating-widget">
								...
								<ul>
									...
									<li>Scenario<span>Čarls Levit</span></li>
									<li>Režiser<span>Edvard Zvik</span></li>
									<li>Trajanje<span>143 min.</span></li>
								</ul>
								<div class="rating">
