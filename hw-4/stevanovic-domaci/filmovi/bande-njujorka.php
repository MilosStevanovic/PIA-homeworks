					...
					<div id="stickySidebar">
						<div class="widget-item">
							<div class="rating-widget">
								...
								<ul>
									<li>Godina izlaska<span>2002.</span></li>
									
									<li>Scenario<span>Džej Koks</span></li>
									<li>Režiser<span>Martin Skorseze</span></li>
									<li>Trajanje<span>167 min.</span></li>
								</ul>
								<div class="rating">
