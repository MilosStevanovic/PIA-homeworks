	...
	<section class="games-single-page">
		<div class="container">
			<div class="game-single-preview">
				<img src="../img/filmovi-2/dallas-buyers-club.jpg" alt="dallas-buyers-club">
			</div>
			<div class="row">
				<div class="col-xl-9 col-lg-8 col-md-7 game-single-content">
					
					<h2 class="gs-title">Poslovni klub Dalas</h2>
					<h4>O filmu</h4>
                    ...
                    <br><br>
                        ...
                        Godine 1986. Ron saznaje da ima HIV i da mu je ostalo još trideset dana života. Film prati njegovu borbu za život i promenu - od narkomana i homofoba, koji svako veče spava sa drugom ženom, do čoveka koji brani svog prijatelja transeksualca i koji ilegalno nabavlja lekove onima kojima su potrebni.<br><br>
                        
                    Žanr: biografija, drama. <br><br>
                        
                    Glumci: Metju Mekonahi, Džared Leto, Dženifer Garner.
						...
						<div class="widget-item">
							<div class="rating-widget">
								...
								<ul>
									...
									<li>Scenario<span>Kreg Borten</span></li>
									<li>Režiser<span>Žan-Mark Vale</span></li>
									<li>Trajanje<span>117 min.</span></li>
								</ul>
								<div class="rating">
